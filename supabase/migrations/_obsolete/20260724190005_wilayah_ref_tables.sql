...
-- ============================================================
INSERT INTO public.ref_provinsi (kode, nama, ibukota, urutan, aktif) VALUES
...
INSERT INTO public.ref_kabupaten (kode, kode_provinsi, nama, ibukota, jenis, urutan, aktif) VALUES
...
INSERT INTO public.ref_kecamatan (kode, kode_kabupaten, nama, urutan, aktif) VALUES
...
INSERT INTO public.ref_desa (kode, kode_kecamatan, nama, jenis, kode_pos, urutan, aktif) VALUES
...
DO $$
BEGIN
  ALTER TABLE public.penduduk ADD CONSTRAINT fk_penduduk_provinsi FOREIGN KEY (provinsi_id) REFERENCES public.ref_provinsi(id) DEFERRABLE INITIALLY DEFERRED;
EXCEPTION WHEN OTHERS THEN NULL;
END $$;
DO $$
BEGIN
  ALTER TABLE public.penduduk ADD CONSTRAINT fk_penduduk_kabupaten FOREIGN KEY (kabupaten_id) REFERENCES public.ref_kabupaten(id) DEFERRABLE INITIALLY DEFERRED;
EXCEPTION WHEN OTHERS THEN NULL;
END $$;
DO $$
BEGIN
  ALTER TABLE public.penduduk ADD CONSTRAINT fk_penduduk_kecamatan FOREIGN KEY (kecamatan_id) REFERENCES public.ref_kecamatan(id) DEFERRABLE INITIALLY DEFERRED;
EXCEPTION WHEN OTHERS THEN NULL;
END $$;
DO $$
BEGIN
  ALTER TABLE public.penduduk ADD CONSTRAINT fk_penduduk_desa FOREIGN KEY (desa_id) REFERENCES public.ref_desa(id) DEFERRABLE INITIALLY DEFERRED;
EXCEPTION WHEN OTHERS THEN NULL;
END $$;
DO $$
BEGIN
  ALTER TABLE public.penduduk ADD CONSTRAINT fk_penduduk_dusun FOREIGN KEY (dusun_id) REFERENCES public.ref_dusun(id) DEFERRABLE INITIALLY DEFERRED;
EXCEPTION WHEN OTHERS THEN NULL;
END $$;
DO $$
BEGIN
  ALTER TABLE public.penduduk ADD CONSTRAINT fk_penduduk_rw FOREIGN KEY (rw_id) REFERENCES public.ref_rw(id) DEFERRABLE INITIALLY DEFERRED;
EXCEPTION WHEN OTHERS THEN NULL;
END $$;
DO $$
BEGIN
  ALTER TABLE public.penduduk ADD CONSTRAINT fk_penduduk_rt FOREIGN KEY (rt_id) REFERENCES public.ref_rt(id) DEFERRABLE INITIALLY DEFERRED;
EXCEPTION WHEN OTHERS THEN NULL;
END $$;
...
BEGIN
  ...
  WHERE tenant_id IS NOT NULL AND (
    provinsi_id IS NULL OR kabupaten_id IS NULL OR
    kecamatan_id IS NULL OR desa_id IS NULL
  );
END $$;
